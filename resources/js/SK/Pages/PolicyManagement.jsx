    ...
    <div className="container policy-section" style={{ marginTop: "100px" }}>
      ...
      <div className="row">
        ...
        <div className="user-info">
          ...
          <div className="tabs">
            {/* Only render the CityPolicies tab if user is federation admin */}
            {isFederationAdmin && (
              <button
                className={`tab ${activeTab === 'CityPolicies' ? 'active' : ''}`}
                onClick={() => handleTabChange('CityPolicies')}
              >
                City Policies
              </button>
            )}
            <button
              className={`tab ${activeTab === 'BarangayPolicies' ? 'active' : ''}`}
              onClick={() => handleTabChange('BarangayPolicies')}
            >
              Barangay Policies
            </button>
          </div>
